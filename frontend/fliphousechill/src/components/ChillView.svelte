...
<div class="w-full h-full min-h-[420px]" style="background-image: url('/bg-image.png'); background-repeat: repeat; background-size: 300px 300px;">
  <swiper-container
    effect="cards"
    grab-cursor="true"
  ...
  >
    {#each cache.slice(0, 7) as entry, i}
      <swiper-slide class="bg-[#f6e7c1] rounded-2xl shadow-md px-8 pt-10 pb-6 flex flex-col justify-end items-start min-h-[340px] relative overflow-hidden">
